...
create_generated_clock -name pgp4PhyTxPcsClk0  [get_pins -hier -filter {name =~ */GEN_LANE[0].GEN_PGP4.U_Lane/REAL_PGP.U_Pgp/*/TXOUTCLKPCS}]
create_generated_clock -name pgp4PhyTxPcsClk1  [get_pins -hier -filter {name =~ */GEN_LANE[1].GEN_PGP4.U_Lane/REAL_PGP.U_Pgp/*/TXOUTCLKPCS}]
create_generated_clock -name pgp4PhyTxPcsClk2  [get_pins -hier -filter {name =~ */GEN_LANE[2].GEN_PGP4.U_Lane/REAL_PGP.U_Pgp/*/TXOUTCLKPCS}]
create_generated_clock -name pgp4PhyTxPcsClk3  [get_pins -hier -filter {name =~ */GEN_LANE[3].GEN_PGP4.U_Lane/REAL_PGP.U_Pgp/*/TXOUTCLKPCS}]
...
set_clock_groups -asynchronous \
    ...
    -group [get_clocks -include_generated_clocks {pgp4PhyTxPcsClk0}] \
...
set_clock_groups -asynchronous \
    ...
    -group [get_clocks -include_generated_clocks {pgp4PhyTxPcsClk1}] \
    -group [get_clocks -include_generated_clocks {qsfp0RefClkP0}] \
    -group [get_clocks -include_generated_clocks {pciRefClkP}] \
    -group [get_clocks -include_generated_clocks {userClkP}]
...
set_clock_groups -asynchronous \
    ...
    -group [get_clocks -include_generated_clocks {pgp4PhyTxPcsClk2}] \
    -group [get_clocks -include_generated_clocks {qsfp0RefClkP0}] \
    -group [get_clocks -include_generated_clocks {pciRefClkP}] \
    -group [get_clocks -include_generated_clocks {userClkP}]
...
set_clock_groups -asynchronous \
    ...
    -group [get_clocks -include_generated_clocks {pgp4PhyTxPcsClk3}] \
    -group [get_clocks -include_generated_clocks {qsfp0RefClkP0}] \
    -group [get_clocks -include_generated_clocks {pciRefClkP}] \
    -group [get_clocks -include_generated_clocks {userClkP}]
